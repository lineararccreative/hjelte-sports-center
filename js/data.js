...
window.HJELTE = {
  ...
  config: {
    ...
    projectAreas: ["Restrooms", "Facility updates", "Fields & turf", "Seating & shade", "Safety & lighting", "Accessibility", "Equipment", "Signage & wayfinding", "Water & irrigation"]
  },
  ...
  /* ------------------------------------------------------------------
     ...
     ------------------------------------------------------------------ */
  mapLocations: [
    { id: "outfield", name: "Shared Outfield", kind: "Open Turf", sport: "soccer", shape: "rect", x: 31.6, y: 10.1, w: 56.8, h: 81.2, lx: 60, ly: 15.5, facility: "outfield",
      fieldInfo: "One continuous grass outfield (~540 × 540 ft) shared by all four diamonds and the cricket ground.", uses: "Soccer, ultimate, fitness and family days when diamonds and cricket are not in play.", accessibility: "Level grass; firm dirt road around the perimeter." },
    { id: "cricket", name: "Los Angeles Cricket Ground", kind: "Cricket Ground", sport: "cricket", shape: "circle", x: 60, y: 50.7, r: 22, lx: 60, ly: 60, facility: "cricket",
      fieldInfo: "20 × 80 ft prepared natural-turf pitch at the center of the outfield; playing area is a 420 ft circle (210 ft radius) marked by a rope boundary on match days.", uses: "Permitted cricket activity area: youth coaching, practice and community matches.", accessibility: "Grass approach from the west entrance; stay outside the rope while play is on." },
    { id: "sbA", name: "Softball Diamond A", kind: "Softball Diamond", sport: "softball", shape: "circle", x: 36.9, y: 17.7, r: 7.9, facility: "sbA",
      fieldInfo: "Upper-left diamond. Skinned infield, backstop, lights. Home plate at the outer corner; outfield faces the center.", uses: "Leagues, youth fast-pitch, tournaments.", accessibility: "Closest diamond to the parking lot." },
    { id: "sbB", name: "Softball Diamond B", kind: "Softball Diamond", sport: "softball", shape: "circle", x: 83.1, y: 17.7, r: 7.9, facility: "sbB",
      fieldInfo: "Upper-right diamond. Skinned infield, backstop, lights. 544 ft home-plate span to Diamond A.", uses: "Leagues, youth baseball practices, tournaments.", accessibility: "Reached along the perimeter road." },
    { id: "sbC", name: "Softball Diamond C", kind: "Softball Diamond", sport: "softball", shape: "circle", x: 36.9, y: 83.7, r: 7.9, facility: "sbC",
      fieldInfo: "Lower-left diamond. Skinned infield, backstop, lights. 543 ft span to Diamond A.", uses: "Weeknight adult leagues.", accessibility: "Short walk from the access road." },
    { id: "sbD", name: "Softball Diamond D", kind: "Softball Diamond", sport: "softball", shape: "circle", x: 83.1, y: 83.7, r: 7.9, facility: "sbD",
      fieldInfo: "Lower-right diamond. Skinned infield, backstop, lights. 536 ft span to Diamond C.", uses: "Leagues, youth baseball, kickball, open play when available.", accessibility: "Reached along the perimeter road." },
    { id: "parking", name: "Parking (west lot)", kind: "Parking", sport: null, shape: "rect", x: 6, y: 12, w: 16, h: 76,
      fieldInfo: "Unpaved lot along the west side of the field.", uses: "Visitor parking, team drop-off.", accessibility: "Level; short distance to the field entrance." },
    { id: "restrooms", name: "Restrooms & Storage", kind: "Restrooms", sport: null, shape: "pin", x: 27, y: 42,
    ...
    { id: "entranceMain", name: "Field Entrance (from parking)", kind: "Entrance", sport: null, shape: "pin", x: 31.6, y: 62,
      fieldInfo: "Main pedestrian entry from the west lot onto the outfield.", uses: "Arrival, drop-off, wayfinding.", accessibility: "Firm surface from parking to the grass edge." },
    { id: "westLawn", name: "West Lawn & Picnic Area", kind: "Open Lawn", sport: "community", shape: "rect", x: 23.5, y: 26, w: 7, h: 48, lx: 27, ly: 78, facility: "westLawn",
      fieldInfo: "Grass and shade strip between the parking lot and the field.", uses: "Picnics, warm-ups, informal games, community gatherings.", accessibility: "Level; adjacent to parking and restrooms." },
    { id: "seating", name: "Bleachers & Lights", kind: "Seating", sport: null, shape: "pin", x: 91, y: 6,
      fieldInfo: "Bleachers and light poles sit behind each backstop at the four corners.", uses: "Spectators, team gatherings.", accessibility: "Firm approach; shade is limited." },
    { id: "accessRoad", name: "Access Road (Burbank Blvd side)", kind: "Entrance", sport: null, shape: "pin", x: 14, y: 93,
      fieldInfo: "Vehicle access from Burbank Blvd to the west lot.", uses: "Arrival and departure.", accessibility: "Unpaved; drive slowly around pedestrians." },
    { id: "path", name: "Perimeter Road & Path", kind: "Path", sport: "fitness", shape: "pin", x: 94, y: 50, facility: "path",
      fieldInfo: "Dirt road looping the east and south edges, connecting to the wider Sepulveda Basin trail network.", uses: "Walking, running, warm-ups.", accessibility: "Firm dirt surface; uneven after rain." }
  ],
