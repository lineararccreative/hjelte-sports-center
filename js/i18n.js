...
(function () {
  ...
  const ES = {
    ...
    "Softball Diamond 1 (upper left)": "Diamante de sóftbol 1 (superior izquierdo)", "Softball Diamond 2 (upper right)": "Diamante de sóftbol 2 (superior derecho)", "Softball Diamond 3 (lower left)": "Diamante de sóftbol 3 (inferior izquierdo)", "Softball Diamond 4 (lower right)": "Diamante de sóftbol 4 (inferior derecho)", "Los Angeles Cricket Ground (center)": "Campo de Críquet de Los Ángeles (centro)", "Shared Outfield": "Jardín compartido", "West Lawn & Picnic Area": "Césped oeste y área de pícnic", "Perimeter Road & Path": "Camino perimetral",
    "Softball Diamond 1": "Diamante de sóftbol 1", "Softball Diamond 2": "Diamante de sóftbol 2", "Softball Diamond 3": "Diamante de sóftbol 3", "Softball Diamond 4": "Diamante de sóftbol 4", "Diamond 1": "Diamante 1", "Diamond 2": "Diamante 2", "Diamond 3": "Diamante 3", "Diamond 4": "Diamante 4", "Cricket Ground": "Campo de críquet", "Parking": "Estacionamiento", "West Lawn": "Césped oeste", "Restrooms": "Baños", "Field entrance": "Entrada al campo", "Entrance": "Entrada", "Access road": "Camino de acceso", "Perimeter Road": "Camino perimetral", "Bleachers": "Gradas",
    ...
    "Group": "Grupo", "Program": "Programa", "Permit status": "Estado del permiso", "Days": "Días", "Paid": "Pagado", "Unpaid": "Sin pago", "Add Your Group": "Agrega tu grupo", "Do You Play at Hjelte?": "¿Juegas en Hjelte?", "Help make the community directory more complete.": "Ayuda a completar el directorio comunitario.",
    ...
    "Four softball diamonds share one outfield with the Los Angeles Cricket Ground at its center, and four soccer/football areas sit in the open space around it. Switch the control below to see what stays open while a given sport is in play, then tap any area for its details and schedule.": "Cuatro diamantes de softbol comparten un solo jardín con el Los Angeles Cricket Ground en el centro, y cuatro áreas de fútbol ocupan el espacio abierto alrededor. Usa el control de abajo para ver qué queda disponible mientras se juega cada deporte, y toca cualquier área para ver sus detalles y su horario.",
    "Adult softball — league play": "Sóftbol adulto — juego de liga", "Field maintenance": "Mantenimiento del campo", "Los Angeles Cricket — match": "Los Angeles Cricket — partido", "Los Angeles Cricket — practice": "Los Angeles Cricket — entrenamiento",
    "Funding needed:": "Financiamiento necesario:", "TBD": "Por definir", "Materials & services": "Materiales y servicios", "The completed pitch at Hjelte, set up for play.": "El terreno terminado en Hjelte, listo para jugar.",
    "Close image": "Cerrar imagen", "Image viewer": "Visor de imágenes", "Target TBD": "Objetivo por definir",
    "Los Angeles Cricket Ground": "Campo de Críquet de Los Ángeles",
    "Irrigation Repair — Shared Outfield": "Reparación de riego — jardín compartido",
    "Restroom Building Refresh": "Renovación del edificio de baños",
    "Field Numbers & Wayfinding Signs": "Números de campo y señalización",
    ...
    "YOUTH REC": "REC. JUVENIL", "PRO": "PRO", "Youth recreational cricket & Minor League Cricket": "Críquet recreativo juvenil y Minor League Cricket", "Youth recreational to Minor League": "De recreativo juvenil a Minor League",
    "Nonprofit uniting Los Angeles across cultures and neighborhoods through cricket. Developed the natural-turf pitch at Hjelte and runs youth recreational coaching and community sessions ahead of the LA28 Games. Los Angeles Cricket also organizes Minor League Cricket at Hjelte for LA Lashings, and the Lashings squad runs free community clinics to introduce the game to new players of any age.": "Organización sin fines de lucro que une a Los Ángeles entre culturas y vecindarios a través del críquet. Desarrolló el terreno de césped natural en Hjelte y ofrece entrenamiento recreativo juvenil y sesiones comunitarias de cara a los Juegos de LA28. Los Angeles Cricket también organiza Minor League Cricket en Hjelte para LA Lashings, y el plantel de Lashings imparte clínicas comunitarias gratuitas para dar a conocer el juego a jugadores nuevos de cualquier edad.",
    "Who plays with your group?": "¿Quién juega en tu grupo?", "Phone *": "Teléfono *", "That answer is not right — please try the sum again.": "Esa respuesta no es correcta; intenta la suma de nuevo.", "Answer in digits — this keeps automated spam out of the directory.": "Responde con números; así evitamos el spam automatizado en el directorio.", "Does your organization currently hold a facility permit? *": "¿Tu organización tiene actualmente un permiso de instalaciones? *",
    "The City of Los Angeles Department of Recreation and Parks maintains Hjelte Sports Center — the fields, the buildings and the grounds. Permitted upkeep and maintenance of the cricket pitch and its playing area is carried out by Los Angeles Cricket. Everything below is the volunteer effort logged on top of that, by the groups who play here.": "El Departamento de Recreación y Parques de la Ciudad de Los Ángeles mantiene Hjelte Sports Center: los campos, los edificios y los terrenos. El mantenimiento autorizado del terreno de críquet y su área de juego lo realiza Los Angeles Cricket. Todo lo que aparece abajo es el trabajo voluntario registrado además de eso, por los grupos que juegan aquí.",
    "City of Los Angeles": "Ciudad de Los Ángeles", "Recreation and Parks": "Recreación y Parques", "Permitted upkeep by": "Mantenimiento autorizado por",
    "Maintains the park: mowing and irrigation, the restroom building, lighting, the diamonds and the shared outfield, waste collection and the perimeter road. Permits for organized activity are issued here too.": "Mantiene el parque: corte de césped y riego, el edificio de baños, la iluminación, los diamantes y el jardín compartido, la recolección de basura y el camino perimetral. Los permisos para actividades organizadas también se emiten aquí.",
    "Maintains the cricket pitch and its playing area under permit: mowing, rolling and crease marking, boundary set-up on match days, and keeping the prepared turf playable between sessions.": "Mantiene el terreno de críquet y su área de juego bajo permiso: corte, rodillo y marcado de líneas, colocación del límite en días de partido y cuidado del césped preparado entre sesiones.",
    "Join": "Únete", "Join the Hjelte Community": "Únete a la comunidad de Hjelte", "Sign up": "Regístrate", "Contribute": "Contribuye",
    "Tell us who you are": "Cuéntanos quién eres", "Full Name *": "Nombre completo *", "I\u2019m joining as *": "Me uno como *",
    "Group or organization name": "Nombre del grupo u organización", "How would you like to help? *": "¿Cómo te gustaría ayudar? *",
    "Join the community list": "Únete a la lista comunitaria", "Chip in when you\u2019re ready": "Contribuye cuando quieras",
    "Individual": "Individual", "Community group": "Grupo comunitario", "Permitted organization": "Organización con permiso", "Business": "Empresa",
    "Monthly maintenance": "Mantenimiento mensual", "One-time project support": "Apoyo puntual a un proyecto", "Volunteer time": "Tiempo voluntario", "Materials or equipment": "Materiales o equipo",
    "You\u2019re on the community list. Check your email for a confirmation.": "Ya estás en la lista comunitaria. Revisa tu correo para la confirmación.",
    ...
    "Hjelte community members administer community contributions for Hjelte projects and upkeep. A 5% share of each contribution covers administration and processing; the rest goes to the fields. Contributions are not payments to the City of Los Angeles and do not grant permit status or exclusive use of any field.": "Los miembros de la comunidad de Hjelte administran las contribuciones comunitarias para los proyectos y el mantenimiento de Hjelte. Un 5% de cada contribución cubre la administración y el procesamiento; el resto va a los campos. Las contribuciones no son pagos a la Ciudad de Los Ángeles y no otorgan permisos ni uso exclusivo de ningún campo.",
    ...
    "Contact us about a permit": "Contáctanos sobre un permiso",
    "Already play here? Add your group →": "¿Ya juegas aquí? Agrega tu grupo →",
    "Nothing scheduled": "Sin actividad programada", "Cricket in play": "Cricket en juego", "Diamonds in play": "Diamantes en juego",
    "All areas are open. The 15 ft buffer around the cricket pitch stays closed at all times so the prepared turf is not damaged.": "Todas las áreas están abiertas. La franja de 15 pies alrededor del terreno de cricket permanece cerrada en todo momento para no dañar el césped preparado.",
    "Cricket has the 420 ft circle. All four diamonds stay open, and so do the parts of the soccer/football areas that fall outside the boundary — the shaded portions are not available, and play should never run alongside or across the circle.": "El cricket ocupa el círculo de 420 pies. Los cuatro diamantes siguen abiertos, igual que las partes de las áreas de fútbol que quedan fuera del límite; las zonas sombreadas no están disponibles y el juego nunca debe desarrollarse junto al círculo ni cruzarlo.",
    "The diamonds are in use. The cricket ground and all four soccer/football areas stay open; keep clear of the ground behind each backstop and watch for foul balls.": "Los diamantes están en uso. El terreno de cricket y las cuatro áreas de fútbol siguen abiertos; mantente alejado del espacio detrás de cada malla y ten cuidado con las bolas foul.",
    "Map key": "Leyenda del mapa", "Open turf": "Césped abierto", "Softball diamond": "Diamante de softbol", "Soccer / football area": "Área de fútbol",
    "Cricket playing area (420 ft boundary)": "Área de juego de cricket (límite de 420 pies)",
    "Protected pitch zone — 15 ft buffer, no activities": "Zona protegida del terreno: franja de 15 pies, sin actividades",
    "Closed while cricket is in play": "Cerrada mientras se juega cricket",
    "Bleachers behind each home plate": "Gradas detrás de cada home",
    "Drawn to scale from measured home-plate spans (Google Maps estimates, not a survey). 4 Diamonds, 1 Cricket Circle playing area.": "Dibujado a escala a partir de las distancias medidas entre homes (estimaciones de Google Maps, no un levantamiento topográfico). 4 diamantes y 1 círculo de cricket como área de juego.",
    "Shared Outfield": "Jardín compartido", "Cricket Ground": "Terreno de cricket", "Protected Pitch Zone": "Zona protegida del terreno", "Protected zone": "Zona protegida", "Protected Area": "Área protegida",
    "Soccer / Football — North": "Fútbol — Norte", "Soccer / Football — South": "Fútbol — Sur", "Soccer / Football — West": "Fútbol — Oeste", "Soccer / Football — East": "Fútbol — Este",
    "Soccer / Football Area": "Área de fútbol", "Soccer N": "Fútbol N", "Soccer S": "Fútbol S", "Soccer W": "Fútbol O", "Soccer E": "Fútbol E",
    "Diamond 1": "Diamante 1", "Diamond 2": "Diamante 2", "Diamond 3": "Diamante 3", "Diamond 4": "Diamante 4",
    "Field entrance": "Entrada al campo", "Field Entrance (from parking)": "Entrada al campo (desde el estacionamiento)",
    ...
    "Infield grooming — Diamonds 1–2": "Acondicionamiento del cuadro — Diamantes 1–2",
