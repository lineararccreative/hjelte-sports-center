...
(function () {
  ...
  const ES = {
    ...
    "Los Angeles Cricket administers community contributions for Hjelte projects and upkeep. A 5% share of each contribution covers administration and processing; the rest goes to the fields. Contributions are not payments to the City of Los Angeles and do not grant permit status or exclusive use of any field.": "Los Angeles Cricket administra las contribuciones comunitarias para los proyectos y el mantenimiento de Hjelte. Un 5% de cada contribución cubre la administración y el procesamiento; el resto va a los campos. Las contribuciones no son pagos a la Ciudad de Los Ángeles y no otorgan permisos ni uso exclusivo de ningún campo.",
